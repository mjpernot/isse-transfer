...
setuptools.setup(
    name="ISSE_Guard_Transfer",
    description="Process and send pre-reviewed files to an ISSE Guard system.",
    author="Mark Pernot",
    author_email="Mark.J.Pernot@coe.ic.gov",
    url="https://sc.appdev.proj.coe.ic.gov/JAC-DSXD/isse-transfer",
