...
"""Program:  process_images.py

    Description:  Unit testing of process_images in isse_guard_transfer.py.
    ...
    def setUp(self):
        ...
        class MoveToFile(object):
            ...
            def __init__(self, images):
                ...
                Arguments:
                    (input) images -> List of image files.
        ...
        self.images = ["/dir/path/filename.txt"]
        self.move = MoveToFile(self.images)
